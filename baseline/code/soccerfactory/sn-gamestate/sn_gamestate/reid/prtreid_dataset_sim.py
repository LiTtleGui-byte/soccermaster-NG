...
class ReidDataset(ImageDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        load_dir = Path("/GPFS/rhome/haolinyang/sports/soccernet/sn-gamestate/datasets/SN-GSR-2024/ReID_df")
        # Load dataframes from pickle files
        train_df = pd.read_pickle(load_dir / "train_df.pkl")
        query_df = pd.read_pickle(load_dir / "query_df.pkl")
        gallery_df = pd.read_pickle(load_dir / "gallery_df.pkl")
