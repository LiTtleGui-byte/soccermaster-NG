...
class ReidDataset(ImageDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # # Save dataframes to disk for later use
        # save_dir = Path("/GPFS/rhome/haolinyang/sports/soccernet/sn-gamestate/datasets/SN-GSR-2024/ReID_df")
        # save_dir.mkdir(parents=True, exist_ok=True)
        
        # log.info(f"Saving ReID dataframes to {save_dir}")
        # train_df.to_pickle(save_dir / "train_df.pkl")
        # query_df.to_pickle(save_dir / "query_df.pkl")
        # gallery_df.to_pickle(save_dir / "gallery_df.pkl")
        # exit()
