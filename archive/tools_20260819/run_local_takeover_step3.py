...
INPUT = REPO / ".runtime/local_takeover/g10/sngs10004_refiner/output/refined_sn-gamestate.pklz"
OUTPUT = REPO / ".runtime/local_takeover/g10/sngs10004_step3/states/sn-gamestate.pklz"
REPORT = REPO / "reports/local_takeover/20260819_soccerfactory_step3_sngs10004"
...
def run_once() -> int:
    ...
    from research.experiments.soccerfactory_step3 import run_refiner_preserving_step3 as base
