...
from reproduction.gates.g10_soccerfactory_convert import atomic_pickle_dump, convert_step3


REPO = Path("/home/tianlin/SoccerMaster")
DEFAULT_MANIFEST = REPO / "reproduction/manifests/g10_current_step3_conversion_sngs10004.json"
...
def main() -> int:
    ...
    converted = convert_step3(detections, images, manifest["video_id"])
    ...
    atomic_pickle_dump(converted, output_path)
