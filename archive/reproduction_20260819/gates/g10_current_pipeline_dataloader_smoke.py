...
DEFAULT_MANIFEST = REPO / "reproduction/manifests/g10_current_pipeline_dataloader_smoke_sngs10004.json"
...
def main() -> int:
    ...
    config = load_super_config(experiment_config, str(REPO / "configs/default.yaml"))
    config.update(
        {
