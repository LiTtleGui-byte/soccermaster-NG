...
MANIFEST_PATH = REPO / "research/reproduction/smokes/soccerfactory/manifests/step1.json"
VENDOR_PATHS = [
    REPO / "baseline/code/soccerfactory/tracklab",
    REPO / "baseline/code/soccerfactory/sn-gamestate",
    REPO,
]
OVERALL_TIMEOUT = 900
