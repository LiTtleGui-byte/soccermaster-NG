...
SOURCE = REPO / "baseline/code/soccerfactory/refiner/inference.py"
CONFIG = REPO / "research/reproduction/smokes/soccerfactory/configs/refiner.json"
CHECKPOINT = REPO / "assets/checkpoints/official/soccerfactory/refiner/best_model.pth"
INPUT = REPO / ".runtime/path_smoke_20260819/soccerfactory/sngs10004_enrichment/states/sn-gamestate.pklz"
METADATA = REPO / "archive/reproduction_20260819/manifests/g10_sngs10004_refiner_metadata.json"
WORK = REPO / ".runtime/path_smoke_20260819/soccerfactory/sngs10004_refiner/work"
OUTPUT_DIR = REPO / ".runtime/path_smoke_20260819/soccerfactory/sngs10004_refiner/output"
OUTPUT = OUTPUT_DIR / "refined_sn-gamestate.pklz"
REPORT = REPO / "runs/path_smoke_20260819/soccerfactory/refiner_sngs10004"
...
def preflight() -> dict[str, Any]:
    ...
    if not base.is_file() or not base.is_relative_to(REPO / "baseline/code/soccerfactory/refiner"):
...
def run(checked: dict[str, Any]) -> int:
    ...
    environment.update({
        "PYTHONPATH": str(REPO / "baseline/code/soccerfactory/refiner"),
