...
from soccermaster.data.utils import Compose, ToTensor, RandomResize, Normalize, get_image_hw
...
def build_transforms(config: dict, split: str = "train"):
    from soccermaster.data.utils import ColorJitter, RandomHorizontalFlip, GaussianNoise, GaussianBlur, ClearAugmentationMetas
